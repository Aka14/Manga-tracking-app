...
export default function Login() {
  ...
  return (
    <section class="">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-200 lg:py-0">
        {/* <a
          href="#"
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div class="space-y-4 md:space-y-6" action="#">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label
                      for="remember"
                      class="text-gray-500 dark:text-[#dfd0b8]"
                    >
                      Remember me
                    </label>
                  </div>
              ...
              <button
                type="button"
                onClick={handleLogin}
                class="w-full text-[#dfd0b8] bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[primary-600] dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                Sign in
              </button>
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <a
                  href="sign-up"
                  class="font-medium text-primary-600 hover:underline dark:text-[#dfd0b8]"
                >
                  Sign up
                </a>
              </p>
